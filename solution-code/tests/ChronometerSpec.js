describe('', function () {
  ...
  describe('constructor function', function () {
    ...
    it('Should declare a `timeStartedAt` property', function () {
      expect(chronometer.timeStartedAt).toBeDefined();
    });

    it('`timeStartedAt` should be equal to 0 at the beginning', function () {
      expect(chronometer.timeStartedAt).toEqual(0);
    });
  ...
  describe('startClick function', function () {
    ...
    it('If `timeStartedAt` is 0, we should set the current date to the variable', function () {
      expect(typeof chronometer.timeStartedAt).toEqual('object');
    });
  ...
  describe('setTime function', function () {
    ...
    it('setTime should declare a `seconds` variable to store the 2 characters length seconds value', function () {
      spyOn(chronometer, 'setTime').and.callFake(function () {
        var seconds = this.twoDigitsNumber(this.getSeconds(2));
    ...
    it('`minutes` should equal \'00\' when currentTime is 0', function () {
      chronometer.currentTime = 0;
      spyOn(chronometer, 'setTime').and.callFake(function () {
        var seconds = this.twoDigitsNumber(this.getSeconds(0));
